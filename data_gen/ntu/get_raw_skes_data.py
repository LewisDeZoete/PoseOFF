...
print(f'Total available skeletons NTU-RGB+D: {56880-302}')
print(f'Total available skeletons NTU-RGB+D120: {57600-535}')
...
def get_raw_skes_data():
    """
    Processes raw skeleton data from files, saves the processed data, and logs the frame counts.

    This function performs the following steps:
    1. Loads the skeleton file names from a specified file.
    2. Iterates through each skeleton file, processes the raw body data, and appends it to a list.
    3. Logs the progress of processing every 1000 files.
    4. Saves the processed raw skeleton data to a pickle file.
    5. Saves the frame counts to a text file.
    6. Logs the total number of frames processed.
    7. Saves the frames drop information to a pickle file.
