...
class Feeder(Dataset):
    ...
    Attributes:
        ...
        eval (str): evaluation benchmark split (ucf101 comes with 3, labeeled '1','2' & '3')
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        dest="obs_ratio",
        default="1.0",
        help="Observation ratio, used for training or evaluation (default=1.0)."
    )
    parser.add_argument(
    ...
    if parsed.data_path_overwrite is not None:
        ...
        # Ensure the evaluation keys are strings...
        ...
        arg.feeder_args['data_paths'][arg.evaluation] = parsed.data_path_overwrite
    ...
    logger.debug(f"\tData path: {arg.feeder_args['data_paths'][arg.evaluation]}")
    logger.debug("Feeder args:")
    for key, value in arg.feeder_args.items():
        if key != "labels":
