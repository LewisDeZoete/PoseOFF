...
checkpoint_base_path = f'results/{dataset}/{dataset}_{evaluation}_base.pt'
checkpoint_abs_path = f'results/{dataset}/{dataset}_{evaluation}_abs.pt'
checkpoint_avg_path = f'results/{dataset}/{dataset}_{evaluation}_avg.pt'
checkpoint_cnn_path = f'results/{dataset}/{dataset}_{evaluation}_cnn.pt'
...
# plt.savefig(f'results/plots/{dataset}/loss/Loss_comparison.png')
...
# plt.savefig(f'results/{dataset}-{evaluation}/accuracy/AUC_comparison.png')
